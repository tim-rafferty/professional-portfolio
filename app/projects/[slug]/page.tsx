    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="relative z-10 container mx-auto p-3 sm:p-4 pt-20 sm:pt-24 pb-6 sm:pb-8">
        ...
        <AnimatedSection animation="fade-in">
          <Link
            href="/"
            className="inline-flex items-center text-base sm:text-base text-zinc-400 hover:text-white mb-4 sm:mb-6 transition-colors"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <Card className="bg-zinc-900/70 border-zinc-800 backdrop-blur-sm overflow-hidden">
              <div className="relative h-48 sm:h-64 md:h-80 w-full">
                ...
                <div className="absolute bottom-0 left-0 p-4 sm:p-6">
                  ...
                  <h1 className="font-accent text-xl sm:text-3xl md:text-4xl font-bold">{project.title}</h1>
                  <p className="text-lg sm:text-lg text-zinc-400 mt-1 sm:mt-2 max-w-2xl">{project.shortDescription}</p>
                </div>
              </div>
            </Card>
          </AnimatedSection>
            ...
            <AnimatedSection animation="fade-up" delay={100}>
              <Card className="bg-zinc-900/70 border-zinc-800 backdrop-blur-sm">
                <CardContent className="p-4 sm:p-6">
                  <h2 className="font-accent text-lg sm:text-lg font-bold mb-3 sm:mb-4">Project Overview</h2>
                  <div className="font-body text-white space-y-1">
                    {project.description.map((paragraph, index) => (
                      <p key={index} className="text-base sm:text-base leading-relaxed">
                        {paragraph}
                      </p>
                    ))}
                  </div>
                  ...
                  <AnimatedSection animation="fade-up" delay={200}>
                    ...
                    <ul className="list-disc pl-5 space-y-1 sm:space-y-2 text-sm sm:text-base text-white">
                    ...
                    <div className="flex flex-wrap gap-2 sm:gap-3 mt-6 sm:mt-8">
                      {project.liveUrl && (
                        <Button
                          asChild
                          size="sm"
                          className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-lg sm:text-lg"
                        >
          ...
          <div className="space-y-4 sm:space-y-6">
            <AnimatedSection animation="slide-left" delay={100}>
              <Card className="bg-zinc-900/70 border-zinc-800 backdrop-blur-sm">
                <CardContent className="p-4 sm:p-6">
                  <h2 className="text-lg sm:text-lg font-bold mb-3 sm:mb-4">Project Details</h2>

                  <div className="space-y-3 sm:space-y-4">
                    <div>
                      <h3 className="font-body text-xs sm:text-sm font-medium text-zinc-400">Client</h3>
                      <p className="text-sm sm:text-base">{project.client || "Personal Project"}</p>
                    </div>

                    <div>
                      <h3 className="font-body text-xs sm:text-sm font-medium text-zinc-400">Timeline</h3>
                      <p className="text-sm sm:text-base">{project.timeline}</p>
                    </div>

                    <div>
                      <h3 className="font-body text-xs sm:text-sm font-medium text-zinc-400">Role</h3>
                          ...
                          <Link href={`/projects/${related.slug}`} className="block group">
                            <div className="flex items-center gap-2 sm:gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-base text-zinc-400">{related.category}</p>
                              </div>
                            </div>
                          </Link>
                        </AnimatedSection>
        ...
        <AnimatedSection
          animation="fade-in"
          delay={500}
          className="mt-8 sm:mt-12 py-4 sm:py-6 text-center text-base sm:text-base text-zinc-500"
        >
