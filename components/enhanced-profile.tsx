      ...
      <CardContent className="p-0">
        ...
        <div className="bg-gradient-to-r from-zinc-800/50 to-zinc-900/50 p-4 sm:p-6 flex flex-col items-center border-b border-zinc-800">
          <div className="flex flex-col sm:flex-col items-center w-full">
            <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden mb-4 border-2 border-terracotta-400/20 ring-4 ring-zinc-800/50">
              <Image
            ...
            <div className="text-center">
              <h2 className="font-sans font-medium text-white text-xl sm:text-2xl tracking-wide">Timothy Rafferty</h2>
              <p className="font-accent text-sm text-terracotta-400 mb-1">{personalInfo.title}</p>
        ...
        <Tabs defaultValue="about" className="w-full" onValueChange={setActiveTab}>
          ...
          <TabsContent value="about" className="p-4 sm:p-6 space-y-4 sm:space-y-6 focus:outline-none">
            <div className="space-y-3">
              <h3 className="font-heading text-sm font-normal text-zinc-400 flex items-center">
                <User className="w-4 h-4 mr-2 text-terracotta-400" />
                About Me
              </h3>
            ...
            <div className="space-y-3">
              <h3 className="font-heading text-sm font-normal text-zinc-400 flex items-center">
                <Briefcase className="w-4 h-4 mr-2 text-terracotta-400" />
                Professional Focus
              </h3>
          ...
          <TabsContent value="contact" className="p-4 sm:p-6 space-y-4 focus:outline-none">
            <div className="space-y-4">
              <div className="flex items-start">
                <Mail className="w-5 h-5 mr-3 text-terracotta-400 mt-0.5" />
                <div>
                  <h4 className="font-medium">Email</h4>
                  <a
                    href={`mailto:${personalInfo.email}`}
                    className="text-sm text-zinc-400 hover:text-terracotta-400 transition-colors break-all"
                  >
                    {personalInfo.email}
                  </a>
                </div>
              ...
              <div className="flex items-start">
                <Phone className="w-5 h-5 mr-3 text-terracotta-400 mt-0.5" />
                <div>
                  <h4 className="font-medium">Phone</h4>
                  <a
                    href={`tel:${personalInfo.phone}`}
                    className="text-sm text-zinc-400 hover:text-terracotta-400 transition-colors"
                  >
                    {personalInfo.phone}
                  </a>
                </div>
              ...
              <div className="flex items-start">
                <MapPin className="w-5 h-5 mr-3 text-terracotta-400 mt-0.5" />
                <div>
              ...
              <div className="flex items-start">
                <Clock className="w-5 h-5 mr-3 text-terracotta-400 mt-0.5" />
                <div>
                  <h4 className="font-medium">Working Hours</h4>
                  <p className="text-sm text-zinc-400">Monday - Friday, 9am - 5pm CST</p>
                </div>
              </div>
            </div>
          </TabsContent>
